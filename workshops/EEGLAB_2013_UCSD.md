...
here</b>]({{ site.baseurl }}/assets/pdfs/ProgramLong2013UCS_handson_v20.pdf).
...
dynamics]({{ site.baseurl }}/assets/pdfs/PBR06lo.pdf), Progress in Brain ResearchVol. 159, Ed.Neuper & Klimesch, 2006
...
perspective]({{ site.baseurl }}/assets/pdfs/MakeigOnton_ERP09.pdf). Oxford Handbookof Event-Related Potential Components, Ed. Luck S & Kappenman E, 2011.
...
PDF]({{ site.baseurl }}/assets/pdfs/PlenaryDay1_EEGLAB_UCSD17_Makeig_I.pdf)\]</font>
<font color=mediumblue> 9:30 - 10:15 AM -- ICA decomposition theory &
evaluation (Jason Palmer) [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/PlenaryDay1_ICA_Jpalmer.pdf)\]</font>
<font color=saddlebrown>10:15 - 10:30 AM -- Coffee break</font>

<font color=mediumblue>10:30 - 11:30 AM -- Time-frequency measures (Tim
Mullen) [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/PlenaryDay1_EEGLAB_TFAnalysis.pdf)\] </font>
<font color=mediumblue>11:30 - 12:00 PM -- EEGLAB overview (Arnaud
Delorme) [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/PlenaryDay1_EEGLAB_overview_ADelorme2.pdf)\]</font>
...
PDF]({{ site.baseurl }}/assets/pdfs/PlenaryDay1_BCILAB_Intro.pdf)\]</font>
<font color=mediumblue> 1:40 - 1:55 PM -- SIFT: Modeling and Visualizing
Source Connectivity (Tim Mullen) [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/PlenaryDay1_EEGLAB_SIFT_Intro.pdf)\] </font>
...
PDF]({{ site.baseurl }}/assets/pdfs/C1-A1_DataImport_ERPvisualization.pdf)\]
3:15 - 4:00 -- C1.A2: Data cleaning for ICA (Marissa Westerfield)
[\[Download PDF]({{ site.baseurl }}/assets/pdfs/C1-A2_Cleaning_for_ICA.pdf)\]
4:00 - 5:00 -- C1.A3: Performing ICA and evaluating components (Julie
Onton) [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C1-A3_EvaluatingICs.pdf)\]</font>
<!-- -->
...
PDF]({{ site.baseurl }}/assets/pdfs/C1-B1_Introduction_to_signals_and_signal_processing_in_BCIs.pdf)\]
3:15 - 4:00 -- C1.B2: Introduction to use of machine learning in BCIs
[\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C1-B2-Introduction_to_machine_learning_in_BCIs.pdf)\]
4:00 - 4:30 -- C1.B3: Analysis of event-related potentials in BCIs
[\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C1-B3-Analysis_of_event-related_potentials_in_BCIs.pdf)\]
4:30 - 5:00 -- C1.B4: Practicum: Performing ERP analysis in BCILAB
[\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C1-B4-Practicum_Performing_ERP_analysis_with_BCILAB.pdf)\]</font>
...
PDF]({{ site.baseurl }}/assets/pdfs/EEGLAB_VXII_SIFT_I.pdf)\]
3:15 - 4:00 -- C1.A2: Granger causality, scalp vs. source, adapting to
non-stationarity

4:00 - 5:00 -- C1.A3: Practicum: hands-on walkthrough of SIFT
[\[Download PDF]({{ site.baseurl }}/assets/pdfs/EEGLAB2013_SIFT_Practicum.pdf)\]</font>
...
PDF]({{ site.baseurl }}/assets/pdfs/PlenaryDay2_EEGLAB13_forward_inverse_EEG.pdf)\]
<!-- -->


<font color=mediumblue> 9:15 - 9:30 AM -- NFT: Electrical head modeling
and source localization (Zeynep Akalin Acar) </font> [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/PlenaryDay2_EEGLAB13_NFT_overview13.pdf)\]
...
PDF]({{ site.baseurl }}/assets/pdfs/C2-A1_PlottingICMeasures.pdf)\]
10:30 - 11:15 -- C2.A2: Localizing IC sources using DIPFIT (Julie
Onton)[\[Download PDF]({{ site.baseurl }}/assets/pdfs/C2-A2_DipoleModeling.pdf)\]
11:15 - 12:00 -- C2.A3: Time-frequency dec. and advanced ICA practicum
(Makoto Miyakoshi) </font>[\[Download
envtopo.m]({{ site.baseurl }}/assets/pdfs/envtopo_updated_v3.zip)\] [\[Downloadpdf]({{ site.baseurl }}/assets/pdfs/C2_A3_Time-frequencyDecAndAdvancedICAPracticum_updateJan2017.pdf)\]
<!-- -->
...
processes [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C2-B1-Analysis_of_oscillatory_processes.pdf)\]
10:30 - 11:15 -- C2.B2: Mastering the BCILAB toolbox: scripting and
inner workings [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C2-B2-Mastering_the_BCILAB_toolbox_scripting_and_inner_workings.pdf)\]
11:15 - 12:00 -- C2.B3: Practicum: scripting oscillatory-process
analyses [\[Download
script]({{ site.baseurl }}/assets/pdfs/scripting_tutorial.zip)\] </font>
<!-- -->
...
PDF]({{ site.baseurl }}/assets/pdfs/PlenaryDay2_EEGLAB13_NFT.pdf)\]
...
PDF]({{ site.baseurl }}/assets/pdfs/PlenaryDay2_EEGLAB13_clustering.pdf)\]</font>
...
PDF]({{ site.baseurl }}/assets/pdfs/C3_A1_STUDY_design_Delorme.pdf)\]
3:15 - 4:00 -- C3.A2: Clustering STUDY ICs (Makato Miyakoshi)[\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C3_A2_ClusteringSTUDYICs_MakotoMiyakoshi_v2.pdf)\]
4:00 - 5:00 -- C3.A3: MPT: Measure Projection Analysis (Nima Bigdely
Shamlo) [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/Measure_Projection_EEGLAB_Workshop_13.pdf)\]</font>
<!-- -->
...
PDF]({{ site.baseurl }}/assets/pdfs/C3-B2-The_Lab_Streaming_Layer_for_multi-modal_data_acquisition.pdf)\]
4:00 - 4:30 -- C3.B3: SNAP environment for interactive experimental
control (C. Kothe) [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C3-B3-SNAP_environment_for_interactive_experimental_control.pdf)\]
4:30 - 5:00 -- C3.B4: MoBILAB for analysis of multimodal brain imaging
data (A. Ojeda) [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C3_B4_MoBILAB_AOjeda_v2.1.pdf)\]</font>
<!-- -->
...
PDF]({{ site.baseurl }}/assets/pdfs/PlenaryDay3_STUDY_statistics_ADelorme_v2.pdf)\]
...
PDF]({{ site.baseurl }}/assets/pdfs/C4.A1-EEGLAB2013_practicum_statistics_ADelorme.pdf)\]
10:30 - 11:00 -- C4.A2: Using the std_envtopo and other STUDY plug-ins
(Makoto Miyakoshi)[\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C4_A2_UsingTheStd_envtopoAndOtherSTUDYPlug_ins.pdf)\]
11:00 - 11:30 -- C4.A3: Automated artifact rejection for large scale
analysis (C. Kothe) [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C4-A3-Automated_artifact_rejection_for_large-scale_analsis.pdf)\]
11:30 - 12:00 -- C4.A4: Comparison of auto. artifact rejection methods
(N. Bigdely Shamlo) [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/Comparison_of_ICA_pre-processing_methods_EEGLAb_Workshop_2013.pdf)\]</font>
...
PDF]({{ site.baseurl }}/assets/pdfs/EEGLAB_VXII_SIFT_II.pdf)\] ‎
...
PDF]({{ site.baseurl }}/assets/pdfs/C5-A1-STUDY_basic_scripting.pdf)\]
4:00 - 4:30 -- C5.A2: More advanced EEGLAB scripting with STUDIES
[\[Download PDF]({{ site.baseurl }}/assets/pdfs/C5-A2-STUDY_study_scripting.pdf)\]
4:30 - 5:30 -- C5.A3: Advanced scripting using EEGLAB STUDY structures
</font> [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C5-A3-STUDY_study_scripting.pdf)\]
<!-- -->
...
approaches [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C5-B1-Optimization-based_approaches.pdf)\]
4:00 - 4:30 -- C5.B2: Neuroscience aspects and outlook [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C5-B2-Neuroscience_aspects_and_outlook.pdf)\]
4:30 - 5:30 -- C5.B3: Practicum: extending BCILAB and implementing
custom methods [\[Download
PDF]({{ site.baseurl }}/assets/pdfs/C5-B3-Practicum_Extending_BCILAB_and_implementing_custom_methods.pdf)\][\[Download scripts]({{ site.baseurl }}/assets/pdfs/bcilab_practicum3_scripts.zip)\]</font>
...
PDF]({{ site.baseurl }}/assets/pdfs/Practicum_of_Measure_Projection_EEGLAB_13.pdf)\]
...
[\[Download
PDF]({{ site.baseurl }}/assets/pdfs/EEGLAB2013_Advances_in_EEG_TPJ.pdf)\]
...
[\[Download PDF]({{ site.baseurl }}/assets/pdfs/TrackA_EEGLAB_projects.pdf)\]
<!-- -->
