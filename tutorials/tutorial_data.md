...
- [Eyes open/closed 26 subjects from HBN ds004186 dataset](https://sccn.ucsd.edu/eeglab/download/ds004186subset.zip) in BIDS format (1Gb). See the full dataset [here](https://nemar.org/dataexplorer/detail?dataset_id=ds004186)
