Installing the compiled version of EEGLAB
-----------------------------------------------
...
Instead, go to the installed EEGLAB version and select the file "eeglab_run_this_one_on_osx_or_linux" as shown below.
